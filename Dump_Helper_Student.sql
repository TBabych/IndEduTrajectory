...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$390000$WmIu469CESuD6d8Gr0xTDV$YE8NpAdwSwGZGz66/fOARBh5qMKVWmtOPZipOLEM1Vo=','2022-12-20 07:46:31.446124',1,'admin','','','admin@admin.ua',1,1,'2022-12-18 21:47:50.130699'),(2,'pbkdf2_sha256$390000$GJJx9reSwmZRe3Fj5qvEKK$CCTEMAGbFUjsZYXrUYoY97IN1/wNN0HQ8wMBRGRNv2I=','2022-12-20 19:44:48.772243',0,'panchenko','Андрій','Панченко','',1,1,'2022-12-18 21:49:48.000000');
...
INSERT INTO `django_session` VALUES ('1eaztb6ojleg1svg5vi6idcbnu9bl5tf','.eJxVjDsOwjAQBe_iGlle_BUlPWew1us1DiBbipMq4u4QKQW0b2beJiKuS43r4DlOWVzEWZx-t4T05LaD_MB275J6W-YpyV2RBx3y1jO_rof7d1Bx1G-NToNC67mg0gAUgIiKBnIIZLNT1kDmzMjoCylgxZwSaG-MCoaCeH8A-uk4lA:1p7i2k:gSx_-5JYBna_Nh5kMZGhhy2GTuWlJTGppJbnrdhwdds','2023-01-03 19:12:50.076543'),('k7e6r9xmk2dxrvlpg4mkfmyvpe5b6b1e','.eJxVjDsOwjAQBe_iGlle_BUlPWew1us1DiBbipMq4u4QKQW0b2beJiKuS43r4DlOWVzEWZx-t4T05LaD_MB275J6W-YpyV2RBx3y1jO_rof7d1Bx1G-NToNC67mg0gAUgIiKBnIIZLNT1kDmzMjoCylgxZwSaG-MCoaCeH8A-uk4lA:1p7iXg:1QJBkKLJwMK1Tyy4E_Lle1lnB0_M1xOOI0kZb-jQs7M','2023-01-03 19:44:48.779516'),('mniyh2k3680551jk42k8z4stwuekt5un','.eJxVjEEOwiAQRe_C2hAGihSX7nsGMsOAVA0kpV0Z765NutDtf-_9lwi4rSVsPS1hZnERIE6_G2F8pLoDvmO9NRlbXZeZ5K7Ig3Y5NU7P6-H-HRTs5VsnnUbKeI6OwJHyqAbtEIzP0bPylpEGnQFMBh49O8smIXgAsjlHBvH-APoiOIc:1p72R8:K_MDKhhIm0l4SuQNtlfFwxRVia3Ce7tHXK1Hs891HRE','2023-01-01 22:47:14.090254');
...
INSERT INTO `indplan_category_subject` VALUES (1,'загальної підготовки'),(2,'фахової підготовки'),(3,'вільний вибір'),(4,'спецкурс');
...
INSERT INTO `indplan_educationprogrammainsubject` VALUES (1,1,2,'ОК01',2),(2,1,6,'ОК02',1),(3,1,7,'ОК03',1),(4,1,8,'ОК04',5),(5,1,9,'ОК05',1),(6,1,10,'ОК06',1);
...
CREATE TABLE `indplan_groupstudent` (
  ...
  KEY `indplan_groupstudent_slug_207afe9b` (`slug`),
...
CREATE TABLE `indplan_subject` (
  ...
  KEY `indplan_subject_slug_6974ca3d` (`slug`),
...
INSERT INTO `indplan_subject` VALUES (1,'Електроніка та мікропроцесорні','elektriniki_ta_micropro',3,2,5,1,NULL),(2,'Українська мова (за професійним спрямуванням)','ukr_mova',3,1,1,2,NULL),(3,'Методи обчислень','metodi_obchislen',3,3,NULL,1,NULL),(4,'Технології створення програмних продуктів','tehn_stvorennya_pp',3,3,5,1,NULL),(5,'Історія  та культура України','istoriya_ukr',4,1,1,2,NULL),(6,'Історія  та культура України','istoriya_ukr',4,1,1,2,NULL),(7,'Іноземна мов','inozemna',5,1,2,2,NULL),(8,'Філософія','filosofiya',3,1,3,2,NULL),(9,'Вища математика','math',12,1,4,1,NULL),(10,'Комп\'ютерна дискретна математика','kdmath',4,1,5,1,NULL);
...
-- Dump completed on 2022-12-20 22:06:11
